...
//  Smack
//
//  Created by Ahmed Dsoky on 12/28/17.
...
class MessageService {
    ...
    func findAllChannel(completion:@escaping ComplectionHandler){
    ...
    // find all message for channel
    
    func findAllMessageForChannel(channelId:String, completion:@escaping ComplectionHandler){
        // alamofire
